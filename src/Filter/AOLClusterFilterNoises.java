 ...
 *
 */
public class AOLClusterFilterNoises {
...
//				System.out.println("error!");
			...
			if(ClassInfo.containsKey(ClassID)){
				...
				try {
					if(linearray[7].length()==4)
					year2++;
				else if(linearray[7].length()==6)
					year4++;
				} catch (Exception e) {
					// TODO: handle exception
				}
	...
	public static void main(String[] args) throws Exception {
		...
		AOLClusterFilterNoises cfn=new AOLClusterFilterNoises();
		String inFile="F:/research/111/time-sensitive query/AOL Data Set/All/Cluster/ClusterFilterNoise.txt";
		String outFile="F:/research/111/time-sensitive query/AOL Data Set/All/Cluster/ClusterFilterALLNoise.txt";
