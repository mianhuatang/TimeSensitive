...
//		TimeParts=NormalizeTimeParts(TimeParts, "Y");
	...
	public static void main(String[] args) throws Exception {
		...
		String inPath="F:/research/111/time-sensitive query/AOL Data Set/All/Cluster/ClusterFilterALLNoise.txt";
		String outPath="F:/research/111/time-sensitive query/AOL Data Set/All/Sensitivity/Sensitivity.txt";
		AOLSensitivity tm=new AOLSensitivity();
		...
		while((line=input.readLine())!=null){
			...
			String TopicPart=lineArray[6];
			String TimePart=lineArray[7];
